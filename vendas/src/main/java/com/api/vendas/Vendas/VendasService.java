...
public class VendasService {
    ...
    public Venda postVenda(VendaCreateDTO vendaCreateDTO, String token){
        ...
        try{
            ResponseEntity<ClienteDTO> responseCliente = estTemplate.exchange("http://34.210.87.17:8080/cliente/exists/" + vendaCreateDTO.getCpfCliente(),HttpMethod.GET, httpEntity, ClienteDTO.class);
